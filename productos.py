...
class Producto():
    ...
    def buscarProducto(self, conexion, nombre_producto, id_producto, precio_producto, disponibilidad, local_pert):
        try:
            with conexion.cursor() as cursor:
    ...
    def actualizarProducto(self, conexion, nombre_producto, id_producto, precio_producto, disponibilidad, local_pert):
        try:
            with conexion.cursor() as cursor:
